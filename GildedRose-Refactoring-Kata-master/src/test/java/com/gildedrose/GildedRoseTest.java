 ...
 class GildedRoseTest {
    ...
    @Test
     void doesNotChangeName() {
        ...
        assertThat(SOME_ITEM, equalTo(rose.items[0].getName()));
    }
    ...
    private GildedRose gildedRoseOf(String agedBrie, int sellIn, int quality) {
        return new GildedRose(new Item[]{anItemOf(agedBrie, sellIn, quality)});
    }
